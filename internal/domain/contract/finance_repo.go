...
type FinanceRepository interface {
	...
	CreatePaymentSchedules(ctx context.Context, schedules []entity.PaymentSchedule) error
	FindContractByID(ctx context.Context, contractID int64) (*entity.LeasingContract, error)
}
