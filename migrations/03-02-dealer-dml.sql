...
INSERT INTO dealer.motors (
    merk, tahun, warna, nomor_rangka, nomor_mesin, cc_mesin, nomor_polisi, 
    status_unit, harga_otr, motor_moty_id
) VALUES
-- Beat 
('Honda', 2026, 'Hitam', 'MH1JF41-001', 'JF41E-001', '109.5 cc', 'D 1234 ABC', 'ready', 18975000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),
('Honda', 2026, 'Merah', 'MH1JF41-002', 'JF41E-002', '109.5 cc', 'D 5678 DEF', 'ready', 19775000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),  -- Deluxe
('Honda', 2026, 'Putih', 'MH1JF41-003', 'JF41E-003', '109.5 cc', NULL, 'booked', 20575000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),  -- Deluxe Smart Key
('Honda', 2026, 'Abu-abu', 'MH1JF41-004', 'JF41E-004', '109.5 cc', 'D 9012 GHI', 'ready', 20075000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),  -- Beat Street

-- Genio & Scoopy
('Honda', 2026, 'Biru', 'MH1JF50-001', 'JF50E-001', '110 cc', 'D 3456 JKL', 'ready', 20175000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),  -- Genio CBS
('Honda', 2026, 'Hitam Metalik', 'MH1JF50-002', 'JF50E-002', '110 cc', NULL, 'ready', 23000000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),  -- Scoopy Fashion

-- Vario 
('Honda', 2026, 'Merah Doff', 'MH1JF60-001', 'JF60E-001', '124.8 cc', 'D 7890 MNO', 'ready', 23775000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),  -- Vario 125 CBS
('Honda', 2026, 'Hitam', 'MH1JF60-002', 'JF60E-002', '124.8 cc', 'D 1122 PQR', 'leased', 25600000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),  -- Vario 125 CBS-ISS
('Honda', 2026, 'Putih', 'MH1JF70-001', 'JF70E-001', '156.9 cc', NULL, 'ready', 28050000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),  -- Vario 160 CBS
('Honda', 2026, 'Abu-abu', 'MH1JF70-002', 'JF70E-002', '156.9 cc', 'D 3344 STU', 'ready', 31075000, (SELECT moty_id FROM dealer.motor_types WHERE moty_name = 'Matic')),  -- Vario 160 ABS
