...
CREATE TABLE leasing.leasing_contract (
    ...
    contract_number     VARCHAR(30) UNIQUE NOT NULL, -- Make NOT NULL
...
CREATE TABLE leasing.leasing_tasks (
    ...
    template_task_id   BIGINT REFERENCES mst.template_tasks(teta_id), -- Added lineage
    startdate          DATE,
    enddate            DATE,
...
CREATE TABLE leasing.leasing_tasks_attributes (
    ...
    tasa_value    TEXT,                                    -- Changed to TEXT
    tasa_status   VARCHAR(15) DEFAULT 'inprogress'
                  CHECK (tasa_status IN ('inprogress', 'pending', 'completed', 'canceled')),
