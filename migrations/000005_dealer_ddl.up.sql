...
CREATE TABLE dealer.customers (
    ...
    user_id        BIGINT UNIQUE REFERENCES account.users(user_id), -- Link ke account.users
...
CREATE TABLE dealer.motors (
    ...
    -- motor_type dihapus, gunakan relasi ke motor_types
...
CREATE INDEX idx_motors_merk_type    ON dealer.motors(merk, motor_moty_id);
